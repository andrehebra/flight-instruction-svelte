...
<CalculatorDisplay>
    ...
    <Heading tag="h3">Bank angle for standard rate turn: {standardRate}</Heading>
    <Heading tag="h3">Bank angle for 1/2 standard rate turn: {halfStandardRate}</Heading>
    ...
    <Heading tag="h3">Rate of Turn (deg/sec): {(Number.isNaN(calculatedRate)) ? 0 : calculatedRate}</Heading>
