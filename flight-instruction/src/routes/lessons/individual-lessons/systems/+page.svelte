    ...
    const systems = [
        ...
        drop: true, title: "Aircraft Controls", contents: [
            {title: "Primary Controls", contents: [
                ...
                {widget: 'text', text: "Adverse yaw is a force generated by the downward deflected aileron producing more drag than the upward deflected aileron. Because the downard deflected aileron is producing more lift, it also produces more drag."},
            ]},
