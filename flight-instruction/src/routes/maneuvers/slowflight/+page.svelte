<script>
    ...
    let displayData = [
        ...
        ["text", 'Unlike what you might be used to, slow flight practices flying in what we refer to as the "back side of the power curve." We can see a depiction of this concept in the image below. Once we fall below our maximum endurance speed, the power required to maintain a given airspeed also increases.'],
        ...
        ["text", "Performance of maneuvering during slow flight is required on both the private and commercial practical tests. However, the commercial ACS requires a tighter tolerance, which is displayed below:"],
        ["heading3", "Knowledge"],
